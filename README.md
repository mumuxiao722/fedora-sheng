...
| **GNOME Mobile** | Use GNOME Mobile from @mobility/gnome-mobile COPR. **NOTE: Packages may not be built for all Fedora versions.** Check build status below before enabling. | `true` / `false` | `false` |

<details>
<summary>COPR Build Status by Fedora Version</summary>
